...
import { aboutTabs, stats, values, teamDisciplines, founders } from "@/data/about";
      ...
      <div className="mx-auto max-w-frame px-6 sm:px-8 lg:px-12">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <SplitHeading text={"A reliable partner\nfrom concept to handover."} as="h2" className="mt-5 font-display text-heading font-semibold text-ink" />
          </div>
          ...
          {tab === "who" && (
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
              <MaskReveal className="aspect-[4/3] rounded-card-lg bg-surface">
                <Image src={TEAM_IMG} alt="Our studio" fill sizes="(max-width:1024px) 100vw, 50vw" className="object-cover" />
              </MaskReveal>
              <div className="flex flex-col justify-center">
                <Reveal>
                  <p className="text-xl leading-relaxed text-secondary">
                    Atrium Design & Build is a trusted interior design and construction partner
                    headquartered in Singapore, delivering integrated fit-out services across
                    industrial, office and retail spaces throughout the Asia Pacific.
                  </p>
                </Reveal>
          ...
          {tab === "team" && (
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
              <div className="flex flex-col justify-center">
                <Reveal>
                  <p className="text-xl leading-relaxed text-secondary">
                    One in-house, multi-disciplinary team carries every project from first survey to
                    final inspection — no hand-offs, no gaps in accountability.
                  </p>
                </Reveal>
